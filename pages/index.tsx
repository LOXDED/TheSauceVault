    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/Home"><a style={{ color: "blue" }}>Homepage - /Home</a></Link></li>
<li><Link href="/item"><a style={{ color: "blue" }}>ItemDrippy - /item</a></Link></li>
<li><Link href="/cart"><a style={{ color: "blue" }}>Cart - /cart</a></Link></li>
<li><Link href="/category"><a style={{ color: "blue" }}>AllSoundKitsPage - /category</a></Link></li>
<li><Link href="/category-2"><a style={{ color: "blue" }}>OneShotSoundKitsPage - /category-2</a></Link></li>
<li><Link href="/category-3"><a style={{ color: "blue" }}>DrumKitSoundKitsPage2 - /category-3</a></Link></li>
          </ul>
